...
#### [KDD-LOAM: Jointly Learned Keypoint Detector and Descriptors Assisted LiDAR Odometry and Mapping](https://arxiv.org/abs/2309.15394) (accepted by ICRA 2024)
...
--YOUR_DATA_PATH--3dmatch--metadata
                        |--data--train--7-scenes-chess--fragments--cloud_bin_0.ply
                              |      |               |          |--...
                              |      |               |--poses--cloud_bin_0.txt
                              |      |                      |--...
                              |      |--...
                              |--test--7-scenes-redkitchen--fragments--cloud_bin_0.ply
                              |      |                   |          |--...
                              |      |                   |--poses--cloud_bin_0.txt
                              |      |                          |--...
                              |      |--...
...
### Citation
If you use this library for any academic work, please cite our original paper [KDD-LOAM](http://arxiv.org/abs/2309.15394) (accepted by ICRA 2024).

...
We provide pre-trained weights in the [release](https://github.com/NeSC-IV/KDD-LOAM/releases/tag/KITTI_KPFCN) page. Please download the latest weights and put them in `weights` directory.

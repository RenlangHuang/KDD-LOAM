...
def load_kernels(radius, num_kpoints, dimension, fixed, lloyd=False):
    ...
    if not exists(kernel_file):
        if lloyd:
            ...
            # Create kernels
            kernel_points, grad_norms = kernel_point_optimization_debug(1.0, num_kpoints, num_kernels=100,
                                                                        dimension=dimension,
                                                                        fixed=fixed, verbose=0)
